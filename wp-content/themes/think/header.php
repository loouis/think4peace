		...
		<div class="wrapper">
			...
			<?php if(is_front_page() ) {?>
				...
				<div class="links-container home-nav" id="menu-center">
					<ul class="nav-links">
						...
						<li class="nav-links__the-schools" ><a href="#" id="google-test" onClick="_gaq.push(['_trackEvent', 'Videos', 'Play', 'abc']);" data-scroll-nav='2'>The Schools we work with</a></li>
			...
			<div class="links-container" id="menu-center">
				<ul class="nav-links">
					...
					<li class="nav-links__the-schools" id="google-test"><a href="<?php bloginfo(url);?>/#the-schools" onClick="_gaq.push(['_trackEvent', 'Videos', 'Play', 'abc']);" >The Schools we work with</a></li>
